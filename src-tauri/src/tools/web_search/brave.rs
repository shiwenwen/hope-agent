...
use super::helpers::{build_search_client, brave_freshness};
use super::{SearchResult, SearchParams};

pub(super) async fn search_brave(api_key: &str, query: &str, count: usize, params: &SearchParams, timeout_secs: u64) -> Result<Vec<SearchResult>> {
    if api_key.is_empty() {
