...
| 章节 | 子文档 | 说明 |
|------|--------|------|
| 2.1 工具系统 | [tool-gap-analysis.md](./tool-gap-analysis.md) | 工具定义、执行引擎、延迟加载、权限过滤 |
| 2.2 Agent 系统 | [agent-system-comparison.md](./agent-system-comparison.md) | Team/Swarm、Coordinator、Worktree、Agent 间消息 |
| 2.3 Skill 系统 | [skill-system-comparison.md](./skill-system-comparison.md) | MCP Skills、Effort 级别、发现机制、Fork 模式 |
| 2.4 Plan Mode | [plan-mode-comparison.md](./plan-mode-comparison.md) | 六态状态机、双 Agent、Git Checkpoint |
| 2.5 记忆系统 | [memory-system-comparison.md](./memory-system-comparison.md) | SQLite vs 文件系统、向量检索、团队同步 |
| 2.6 上下文管理 | [context-management-comparison.md](./context-management-comparison.md) | 5 层压缩、Side Query、Tool Use Summary |
| 2.7 Provider 支持 | [provider-support-comparison.md](./provider-support-comparison.md) | 多 Provider 模板、降级策略、Prompt Cache |
| 2.8 IM 渠道系统 | [im-channel-comparison.md](./im-channel-comparison.md) | 12 vs 24+ 渠道、DM 配对、语音、媒体管道 |
| 2.9 权限与安全 | [permission-security-comparison.md](./permission-security-comparison.md) | 权限模式、MDM、TCC 检查、速率限制 |
| 2.10 IDE 集成 | [ide-integration-comparison.md](./ide-integration-comparison.md) | VS Code Bridge、REPL Bridge、ACP 协议 |
| 2.11 Hooks 系统 | [hooks-system-comparison.md](./hooks-system-comparison.md) | 事件类型、同步/异步 Hook、工具拦截 |
| 2.12 通知系统 | [notification-system-comparison.md](./notification-system-comparison.md) | 优先级队列、通知折叠、失效机制 |
| 2.13 Session 管理 | [session-management-comparison.md](./session-management-comparison.md) | Teleport、远程会话、会话恢复 |
| 2.14 其他独有能力 | [unique-capabilities-comparison.md](./unique-capabilities-comparison.md) | DreamTask、Dashboard、i18n、Canvas |
...
> **详细分析** → [工具差异分析](./tool-gap-analysis.md)
...
> **详细分析** → [Agent 系统对比](./agent-system-comparison.md)
...
> **详细分析** → [Skill 系统对比](./skill-system-comparison.md)
...
> **详细分析** → [Plan Mode 对比](./plan-mode-comparison.md)
...
> **详细分析** → [记忆系统对比](./memory-system-comparison.md)
...
> **详细分析** → [上下文管理对比](./context-management-comparison.md)
...
> **详细分析** → [Provider 支持对比](./provider-support-comparison.md)
...
> **详细分析** → [IM 渠道系统对比](./im-channel-comparison.md)
...
> **详细分析** → [权限与安全对比](./permission-security-comparison.md)
...
> **详细分析** → [IDE 集成对比](./ide-integration-comparison.md)
...
> **详细分析** → [Hooks 系统对比](./hooks-system-comparison.md)
...
> **详细分析** → [通知系统对比](./notification-system-comparison.md)
...
> **详细分析** → [Session 管理对比](./session-management-comparison.md)
...
> **详细分析** → [其他独有能力对比](./unique-capabilities-comparison.md)
