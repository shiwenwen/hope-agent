...
| [Coding Eval 控制面评测](architecture/coding-eval.md) | Phase 3.7-3.10 确定性 fixture harness：临时 git repo + 真实 session/goal/task/workflow/IDE context state，回归 Review / Smart Verification / Context Retrieval 协同质量 | `coding_eval.rs`, `tests/fixtures/coding_eval/` |
