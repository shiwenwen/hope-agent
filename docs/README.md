...
| [知识库系统](architecture/knowledge-base.md)         | **设计草案**：独立 PKM 知识库（真实 `.md` + SQLite 旁路索引）、Wikilink 双链/反链、AI 双向桥（记忆→笔记 / 笔记→召回）、`WorkspaceScope::for_knowledge`、分阶段路线图 | `knowledge/`（规划中）                            |
