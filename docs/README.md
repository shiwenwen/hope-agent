...
| [Coding Improvement Loop](architecture/coding-improvement-loop.md) | Phase 4.1 质量趋势与学习闭环：基于 durable Goal/Workflow/Review/Verification/Eval 数据生成 trend report、failure taxonomy、proposal 队列，并可预览/应用成 eval、workflow、guidance、skill 草稿产物 | `coding_improvement.rs`, `coding_eval.rs`, `components/chat/workspace/` |
