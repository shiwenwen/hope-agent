...
| [Coding Eval 体系方案](coding-eval.md) | Phase 0 人工 gold task 体系 + Phase 3.7-5.1 已落地的确定性控制面 eval / task-level runner 索引 |
