...
| [Coding Eval 体系方案](coding-eval.md) | Phase 0 人工 gold task 体系 + Phase 3.7-5.9 已落地的确定性控制面 eval / agent execution / task-level runner / Gold Task Pack 全量自动化 / strategy effect / mock tool-call 基线 / Strategy Effect 趋势 Dashboard / Release Gate / 外部模型基线索引 |
