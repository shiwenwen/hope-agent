...
| [记忆](memory.md) | 全量备份含全局 / Agent / 项目 Core Memory；恢复后 `invalidate_all_session_snapshots` + `memory:core_changed` 让运行中会话刷新 |
