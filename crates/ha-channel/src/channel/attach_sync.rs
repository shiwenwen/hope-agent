...
fn active_desktop_or_http_turn(
    session_id: &str,
) -> Option<ha_core::chat_engine::active_turn::ActiveTurnSnapshot> {
    ha_core::chat_engine::active_turn::current(session_id)
...
async fn start_late_mirror(
    ...
    chat_id: &str,
    thread_id: Option<&str>,
    active: ha_core::chat_engine::active_turn::ActiveTurnSnapshot,
) -> bool {
