...
pub fn is_globally_configured(name: &str, app_config: &AppConfig) -> bool {
    use crate::tools::{
        TOOL_ACP_SPAWN, TOOL_CANVAS, TOOL_DESIGN, TOOL_IMAGE_GENERATE, TOOL_SEND_NOTIFICATION,
...
static ALL_DISPATCHABLE_TOOLS: LazyLock<Vec<ToolDefinition>> = LazyLock::new(|| {
    use super::definitions::{
        get_acp_spawn_tool, get_available_tools, get_canvas_tool, get_design_tool,
