...
export default function ContextCompactPanel() {
  ...
  useEffect(() => {
    invoke<CompactConfig>("get_compact_config")
      ...
      .catch((e) =>
        logger.error(
          "settings",
          "ContextCompactPanel::load",
          "Failed to load compact config",
          e
        )
      )
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      logger.error(
        "settings",
        "ContextCompactPanel::save",
        "Failed to save compact config",
        e
      )
    } finally {
      setSaving(false)
          ...
          >
            <div className="space-y-0.5">
              <div className="text-sm font-medium">
                {t("settings.contextCompactEnabled")}
              </div>
            ...
            <>
              ...
              <div className="rounded-lg border border-border/50 bg-secondary/20 overflow-hidden">
                ...
                >
                  ...
                  <span className="text-sm font-medium">
                    {t("settings.contextCompactPruning")}
                  </span>
                </button>
                {pruningOpen && (
                ...
                {summaryOpen && (
                  <div className="px-3 pb-3 pt-1 space-y-3 border-t border-border/30">
                    <RatioInput
                      ...
                      desc={t(
                        "settings.contextCompactSummarizationThresholdDesc"
                      )}
                      ...
                      step={0.05}
                      onChange={(v) =>
                        update({ summarizationThreshold: v })
                      }
                    />
                    <NumberField
                    ...
                    <div className="space-y-1">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          update({ identifierPolicy: e.target.value })
                        }
                      >
                        <option value="strict">
                          {t(
                            "settings.contextCompactIdentifierPolicyStrict"
                          )}
                        </option>
                        <option value="off">
                        ...
                        <option value="custom">
                          {t(
                            "settings.contextCompactIdentifierPolicyCustom"
                          )}
                        </option>
                      </select>
                    </div>
                    <NumberField
                      ...
                      max={300}
                      onChange={(v) =>
                        update({ summarizationTimeoutSecs: v })
                      }
                    />
                  </div>
                )}
              ...
              <div className="rounded-lg border border-border/50 bg-secondary/20 overflow-hidden">
                ...
                >
                  ...
                  <span className="text-sm font-medium">
                    {t("settings.contextCompactAdvanced")}
                  </span>
                </button>
                {advancedOpen && (
                  <div className="px-3 pb-3 pt-1 space-y-3 border-t border-border/30">
          ...
          <div className="flex items-center gap-2 pt-2">
            ...
            {justSaved && (
              <span className="text-xs text-green-600">
                {t("settings.contextCompactSaved")}
              </span>
            )}
          </div>
        </div>
