...
export const infrastructureTemplates: ProviderTemplate[] = [
  ...
  },
  {
    key: "requesty",
    name: "Requesty",
    description: "多模型路由网关，一个 Key 用数百个模型",
    icon: "🔀",
    apiType: "openai-chat",
    baseUrl: "https://router.requesty.ai/v1",
    apiKeyPlaceholder: "rqsty-...",
    requiresApiKey: true,
    models: [
      // Requesty 托管路由策略 ID（GET /v1/models/managed），也可直接填写 vendor/model 形式的 ID。
      // 带 @eu 后缀的策略只经欧盟区服务商路由；EU 端点为 https://router.eu.requesty.ai/v1。
      {
        id: "claude-sonnet-5",
